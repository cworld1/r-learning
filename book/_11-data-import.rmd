...
```{R read_csv()}
heights <- read_csv("./book/source/heights.csv")
```
...
```{R write_csv()}
write_csv(challenge, "./book/source/challenge.csv")
```
...
```{R data type}
challenge
write_csv(challenge, "./book/source/challenge-2.csv")
read_csv("./book/source/challenge-2.csv")
```
...
write_rds(challenge, "./book/source/challenge.rds")
read_rds("./book/source/challenge.rds")
```
...
```{R feather}
library(feather)
write_feather(challenge, "./book/source/challenge.feather")
read_feather("./book/source/challenge.feather")
```
